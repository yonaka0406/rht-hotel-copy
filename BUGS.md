...
- **Description**:
  - Enhance the current invoice (請求書) functionality to support multiple export formats
  - Implement a detailed reservation details (予約明細) view and export
- **Key Features**:
  1. **Invoice Export Enhancements**
     - Add Excel export option alongside existing PDF export
     - Preserve all formatting and calculations in Excel format
     - Include all relevant reservation and payment details
  2. **Reservation Details (予約明細)**
     - Create a comprehensive reservation details view
     - Include all charges, payments, and adjustments
     - Support both display and export functionality
- **Implementation Requirements**:
  - Add Excel export option to the invoice generation interface
  - Ensure Excel export maintains proper formatting and formulas
  - Design and implement the reservation details view
  - Include options to print or save reservation details
  - Support both A4 and standard receipt paper sizes
- **Data to Include**:
  - Guest information
...
- **UI/UX Considerations**:
  - Add clear export format selection (PDF/Excel)
  - Include preview functionality before export
  - Show loading indicators during export generation
  - Ensure accessibility of all exported documents
- **Priority**: [ ] Low [ ] Medium [x] High [ ] Critical
- **Additional Notes**:
  - Excel export should be formatted for easy reading and printing
  - Consider adding batch export for multiple reservations
  - Include option to customize which fields appear in the export
...
*Total Feature Requests: 17* (last one #42)