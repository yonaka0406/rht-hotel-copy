...
const { hotels, roomTypeCreate, roomCreate, getHotels, editHotel, editRoomType, editRoom, editHotelCalendar, getHotelRooms, getBlockedRooms, editBlockedRooms } = require('../controllers/hotelsController');
