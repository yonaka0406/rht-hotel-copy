...
router.get('/reservation/room-indicator/:hid/:date', authMiddleware, reservationsController.getRoomsForIndicator);
...
router.get('/reservation/client-list/:hid/:clientId', authMiddleware, reservationsController.getReservationsByClient);
...
router.delete('/reservation/parking/:id', authMiddlewareCRUDAccess, reservationsController.handleDeleteParkingReservation);
router.post('/reservation/parking/bulk-delete', authMiddlewareCRUDAccess, reservationsController.handleBulkDeleteParkingReservations);
router.get('/reservation/parking/spot-availability', authMiddleware, reservationsController.getParkingSpotAvailability);
...
router.post('/reservation/merge', authMiddlewareCRUDAccess, reservationsController.actionMergeReservations);
...
router.put('/reservation/payment/move/:paymentId', authMiddlewareCRUDAccess, reservationsController.moveReservationPayment);
