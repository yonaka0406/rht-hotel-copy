...
const { getClients, getClient, getConvertedName, getClientReservations, getCustomerID, getClientGroups, createClientBasic, createClient, createAddress, createClientGroup, removeAddress, updateClient, updateClientFull, updateAddress, updateClientGroup, mergeClients } = require('../controllers/clientsController');
...
router.post('/client/group/new', authMiddleware, createClientGroup);
router.put('/client/update/:id', authMiddleware, updateClient);
router.put('/client/address/update/:id', authMiddleware, updateAddress);
router.put('/client/group/:gid/update/:id', authMiddleware, updateClientGroup);
