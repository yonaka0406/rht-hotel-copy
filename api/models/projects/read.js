...
async function selectProjectsByClientId(requestId, clientId, dbClient = null) {
...
async function selectAllProjects(requestId, { limit = 10, offset = 0, searchTerm = '', filters = {} }, dbClient = null) {
    const pool = dbClient || getPool(requestId);
    let queryParams = [];
