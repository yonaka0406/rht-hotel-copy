...
const getTopBookers = async (req, res) => {
  ...
  try {
    const result = await crmReportModel.getTopBookers(req.requestId, sdate, edate, includeTemp);
...
const getSalesByClientByMonth = async (req, res) => {
  ...
  try {
    const result = await crmReportModel.getSalesByClientByMonth(req.requestId, sdate, edate, includeTemp);
