<template>
    <div class="p-4">
        <Panel header="カレンダー設定">
                ...
                <template #content>
                    <div class="grid grid-cols-2 gap-4 mb-2">
                        ...
                        <div>
                            ...
                            <MultiSelect name="rooms" v-model="selectedRooms" :options="formattedHotelRooms"
                                optionLabel="formattedRoom" optionValue="room_id"
                                :virtualScrollerOptions="{ itemSize: 38 }" class="w-48" placeholder="部屋選択" filter />
                        </div>
                    </div>
            ...
            <Card>
                <template #content>
                    <DataTable :value="hotelBlockedRooms" dataKey="id" paginator :rows="30"
