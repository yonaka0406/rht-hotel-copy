    ...
    <div class="min-h-screen p-2">
        ...
        <div v-else class="grid grid-cols-12 gap-4">
            ...
            <KPIMetricsPanel :viewMode="viewMode" :displayedCumulativeSales="displayedCumulativeSales"
                ...
                :ADRDifference="ADRDifference" :revPAR="revPAR" :forecastRevPAR="forecastRevPAR"
                :revPARDifference="revPARDifference" :OCC="OCC" :forecastOCC="forecastOCC"
                :OCCDifference="OCCDifference" />

            <LineChartPanel :allReservationsData="allReservationsData" :selectedMonth="selectedMonth"
                :viewMode="viewMode" :metricsEffectiveStartDate="metricsEffectiveStartDate"
                :metricsEffectiveEndDate="metricsEffectiveEndDate" :formatDate="formatDate"
                :normalizeDate="normalizeDate" :addDaysUTC="addDaysUTC" :isWeekend="isWeekend" />

            <HeatMapPanel :selectedMonth="selectedMonth" :allReservationsData="allReservationsData"
                :heatMapDisplayStartDate="heatMapDisplayStartDate" :heatMapDisplayEndDate="heatMapDisplayEndDate"
                :formatDate="formatDate" :normalizeDate="normalizeDate" :addDaysUTC="addDaysUTC" />

            <BookerTypeAndStayDurationPanel :bookerTypeBreakdownData="bookerTypeBreakdownData"
                :reservationListData="reservationListData" />

            <BookingChannelAndPaymentTimingPanel :bookingSourceData="bookingSourceData"
