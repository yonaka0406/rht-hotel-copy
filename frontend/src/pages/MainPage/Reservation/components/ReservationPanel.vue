...
import ReservationEditDialog from '@/pages/MainPage/Reservation/components/dialogs/ReservationEditDialog.vue';
...
const reservationEditDialogRef = ref(null);

const actionOptions = [
    {
        label: 'プラン・期間編集',
        icon: 'pi pi-pencil',
        command: () => reservationEditDialogRef.value.openReservationBulkEditDialog()
    },
    {
        label: '部屋追加',
        icon: 'pi pi-plus',
