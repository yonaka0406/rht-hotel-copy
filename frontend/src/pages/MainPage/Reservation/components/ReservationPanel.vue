<template>
    ...
    <ReservationEditDialog
        ...
        @closeDialog="closeReservationBulkEditDialog"
        @goToNewReservation="goToNewReservation"
...
const openReservationBulkEditDialog = async () => {
    if (reservationEditDialogRef.value) {
        await reservationEditDialogRef.value.open();
    }
};
