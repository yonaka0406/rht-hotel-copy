            ...
            >
                ...
                <AccordionContent>
                    ...
                    <div v-else class="text-left">
                        ...
                        <div v-if="address.representative_name"><span class="font-bold">宛先：</span>{{ address.representative_name }} </div>
                        ...
                        <div class="flex justify-center gap-4">
                            <Button severity="info" icon="pi pi-pencil" label="編集" class="p-button-sm" @click="editAddress(address)" />
                            <Button icon="pi pi-trash" label="削除" class="p-button-sm p-button-danger" @click="confirmDelete(address)" />
                        </div>
                    </div>
                </AccordionContent>
            </AccordionPanel>
        ...
        <Dialog v-model:visible="addressDialogVisible" :header="dialogHeader" :modal="true">
            <form @submit.prevent="saveAddress">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="field mt-4">
                        <FloatLabel>
                            <Select v-model="editedAddress.state" 
                                editable 
                                :options="states" 
                                optionLabel="label" 
                                optionValue="label" 
