...
const Dashboard = () => import('@/pages/MainPage/Dashboard/DashboardPage.vue');
...
const ReservationsCalendar = () => import('@/pages/MainPage/ReservationsCalendar/ReservationsCalendar.vue');
...
const BillingInvoices = () => import('@/pages/MainPage/BillingInvoices/BillingInvoices.vue');
...
const AccountingUtilityBills = () => import('@/pages/Accounting/AccountingUtilityBills/AccountingUtilityBillsPage.vue');
...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'utility-bills', name: 'AccountingUtilityBills', component: AccountingUtilityBills },
    ],
